            ...
            shows:[
                {
                    ...
                    "show": {
                        ...
                        "image": {
                            "medium": "https://static.tvmaze.com/uploads/images/medium_portrait/122/305714.jpg",
                            "original": "https://static.tvmaze.com/uploads/images/original_untouched/122/305714.jpg"
                        },
    ...
    return (
        <SavedListsStyle>
            {showLists.map((showList, index)=>{
                if(showList.shows.length==0) return;
                return(
                    <ShowList name={showList.name} shows={showList.shows}/>
                )
            })}
        </SavedListsStyle>
    )
